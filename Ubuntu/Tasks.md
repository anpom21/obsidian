...
- [ ] Add a groundtruth label at the top as well, make it clear what reference directory is used for the image, as its written with small letters. When passing the  #sandcastle [[Classification]] 
